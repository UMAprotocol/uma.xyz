...
export const Hero = () => {
  return (
    <section
      className="relative mx-auto mt-12 flex max-h-[1200px] max-w-[828px] flex-col items-center justify-center gap-4 overflow-clip  px-[--page-padding] pb-[94px] text-center align-top xl:pb-[128px]"
      style={{
