...
export function Description() {
  return (
    <section className="bg-grey-25 px-4 py-8 sm:px-8 md:px-16 lg:py-[96px] xl:px-[214px]">
      ...
      <h1 className="mb-2 text-center text-4xl font-medium text-grey-500 sm:text-5xl md:text-6xl lg:mb-5 lg:text-8xl">
        Cheaper. Faster.
        <br />
        <span className="text-primary-500">More inclusive.</span>
      </h1>
      <p className="mx-auto mb-2 max-w-[724px] text-center text-lg text-grey-600 sm:text-2xl">
        Add oSnap to your existing Snapshot Space and Safe&#123;wallet&#125; in minutes.
      </p>
      <p className="mx-auto mb-4 max-w-[724px] text-center text-lg text-grey-600 sm:text-2xl lg:mb-6">
