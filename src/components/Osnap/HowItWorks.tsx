...
export function HowItWorks() {
  return (
    <section className="bg-grey-25 px-4 py-8">
      <h2 className="mb-2 text-3xl text-grey-900">A new era of DAO governance</h2>
      <p className="mb-12 text-lg text-grey-600">Explore oSnap&apos;s process and harness Optimistic Execution</p>
      <div>
        <div className="ml-4 grid grid-cols-[calc(48px/2),auto] gap-4 border-l border-dashed border-red/40 pb-10">
        ...
        <div className="ml-4 grid grid-cols-[calc(48px/2),auto] gap-4 border-l border-dashed border-red/40 pb-10">
          ...
          <div>
            ...
            <p className="text-grey-600">
              Customize your integration by setting the bond currency and size, challenge period duration, voting period
              duration and required quorum.
            </p>
          </div>
        </div>
        <div className="ml-4 grid grid-cols-[calc(48px/2),auto] gap-4 border-l border-dashed border-red/40 pb-10">
        ...
        <div className="ml-4 grid grid-cols-[calc(48px/2),auto] gap-4 border-l border-dashed border-red/40 pb-10">
          ...
          <div>
            ...
            <p className="text-grey-600">The outcome is sent to UMA, where for a limited time anyone can dispute it.</p>
          </div>
        </div>
        <div className="ml-4 grid grid-cols-[calc(48px/2),auto] gap-4 border-l border-dashed border-red/40 pb-10">
          <div className="w-[48px]">
        ...
        <div className="ml-4 grid grid-cols-[calc(48px/2),auto] gap-4 pb-10">
          <div className="w-[48px]">
